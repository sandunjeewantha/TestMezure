    ...
    <div class="container">
        <div class="row">
            <div class="row col-12">
                ...
                $edData = mysqli_fetch_assoc(GetOneTestDesignById($edtcid));

                ?>
                <div class="col-8 mt-3">
                    <h3><?php echo $edmode ? 'EDIT' : 'ADD NEW' ?> TEST DESIGN</h3>
                 
                    <form action="" method="POST" class="mt-3">
                        <div class="row">
                            <select class="form-select" id="folderSelect" name="testCaseFolder">
                                <option selected value="0">Select Folder</option>
                                <?php
                                $allFolder = GetFolder();
                        ...
                        <div class="row card mb-3 mt-3">
                            <div class="card-body">
                                <div class="card-body">
                                        ...
                                        <?php echo $edmode ? $edData['testcase'] : 'All QA Documentation Like Test Plans/Test Data / Reports / Metrics / Coverages /Releases/ Defects & All Kind of Documentation.' ?> 
                                ...
                                <?php
                                if ($edmode) { ?>
                                    <button type="submit" name="btnEdittestDesign" class="btn btn-primary btn-sm">Update Test Design</button>
                                <?php
                                } else {
                                ?>
                                    <button type="submit" name="btnAddtestDesign" class="btn btn-primary btn-sm">Add Test Design</button>
                                <?php
                                }
                                ?>
                            </div>
