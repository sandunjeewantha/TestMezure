    ...
    <div class="container">
        <div class="row">
            <div class="row col-12">
                ...
                $edData = mysqli_fetch_assoc(GetOneOtherById($edtcid));

                ?>
                <div class="col-8 mt-3">
                    <h3><?php echo $edmode ? 'EDIT' : 'ADD NEW' ?> OTHER TEST</h3>
                        ...
                        <div class="row card mb-3 mt-3">
                            <div class="card-body">
                                <div class="card-body">
                                        ...
                                        <?php echo $edmode ? $edData['testcase'] : 'Handle Your Other Project & QA Reated Thing ' ?>  
                                        </textarea>
                                        <script>
                                            tinymce.init({
                                                selector: 'textarea',
                                ...
                                <?php
                                if ($edmode) { ?>
                                    <button type="submit" name="btnEdittestOther" class="btn btn-primary btn-sm">Update Other Test Case</button>
                                <?php
                                } else {
                                ?>
                                    <button type="submit" name="btnAddtestOther" class="btn btn-primary btn-sm">Add Other Test Case</button>
                                <?php
                                }
                                ?>
                            </div>
