    ...
    <div class="container">
        <div class="row">
            <div class="row col-12">
                ...
                $edData = mysqli_fetch_assoc(GetOneAutomationById($edtcid));

                ?>
                <div class="col-8 mt-3">
                    <h3><?php echo $edmode ? 'EDIT' : 'ADD NEW' ?> TEST AUTOMATION</h3>
                        ...
                        <div class="row card mb-3 mt-3">
                            <div class="card-body">
                                <div class="card-body">
                                        ...
                                        <?php echo $edmode ? $edData['testcase'] : 'Manage Your Automation here..' ?> 
                                        </textarea>
                                        <script>
                                            tinymce.init({
                                                selector: 'textarea',
                                ...
                                <?php
                                if ($edmode) { ?>
                                    <button type="submit" name="btnEdittestAutomation" class="btn btn-primary btn-sm">Update Test Automation</button>
                                <?php
                                } else {
                                ?>
                                    <button type="submit" name="btnAddtestAutomation" class="btn btn-primary btn-sm">Add Test Automation</button>
                                <?php
                                }
                                ?>
                            </div>
